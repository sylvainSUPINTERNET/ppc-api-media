...
def upload_media(media, user_email, user_uuid, collectionMedia):
    ...
    newMedia = Media(file_base_64=media_b64_str, extension=extension, user_email=user_email, user_uuid=user_uuid, uuid=str(generated_uuid),created_at=now, updated_at=now)
